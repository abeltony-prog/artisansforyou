       ...
       <div class="row div-center">
              <div class="content col-md-12">
                ...
                <form class="" action="" method="post">
                  ...
                  <a class="btn btn-default" href="Myprofile.php">Go Back</a><br><br><br>
                </form>
                <?php
                    if (isset($_POST['update'])) {
                      $states = $_POST['state'];
                      DB::query('UPDATE users SET location_id=:location_id WHERE id=:userid', array(':location_id'=>$states,':userid'=>$user['id']));
                      echo "
