...
<head>
    ...
    <title>Account Verification | Artisans For You</title>
              ...
              <div class="content">
                ...
                <?php
                  if (isset($_POST['verify'])) {
                    $code= $_POST['code'];
                    $users = DB::query('SELECT * FROM artisans WHERE vkey=:vkey', array(':vkey'=>$code));
                    foreach ($users as $key) {
                      if ($key['verified'] == "0") {
                        $verified= "1";
                        DB::query('UPDATE artisans SET verified=:verified WHERE id=:id', array(':verified'=>$verified,':id'=>$key['id']));
