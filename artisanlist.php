    ...
    <div class="container">
      ...
      <a class="navbar-brand" href="#index.html">
        ...
        <div class="d-lg-block d-none">
          <a href="#" class="btn btn-style btn-secondary">Get started</a>
        </div>
  ...
  <section class="w3l-about-breadcrumb text-left">
    <div class="breadcrumb-bg breadcrumb-bg-about py-sm-5 py-4">
      <div class="container py-2">
        <h2 class="title">Artisan in "NAME OF THE CITY"</h2>
        <ul class="breadcrumbs-custom-path mt-2">
          <li><a href="index.html">Home</a></li>
          <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span> Artisans </li>
        </ul>
      </div>
    </div>
  </section><br>
      ...
      <div class="grid search">
        <div class="grid-body">
          <div class="row">
            ...
            <!-- BEGIN RESULT -->
            <div class="col-md-12">
              <h2><i class="fa fa-file-o"></i> City</h2>
              <hr>
              <!-- BEGIN SEARCH INPUT -->
                ...
                <div class="col-sm-6">
                  <div class="btn-group">
                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                      Artisans <span class="caret"></span>
                    </button>
                  ...
                  <tbody>
                      <a href="">
                        <tr>
                            ...
                            <td class="rate "> <a class=" btn btn-seconday" href="#"><span><i class="fa fa-eye"></i></span></a> </td>
                          </tr>
                      </a>
                  <tr>
