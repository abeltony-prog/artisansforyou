...
<head>
  ...
  <title>Artisan Categories - Artisan For you</title>
...
<?php include('layout.php') ?>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-users"></i> Artisan Categories List</h3>
            <ol class="breadcrumb">
  ...
  <thead>
    <tr>
      <th scope="col">Artisan CategoriesList</th>
  ...
  <tbody>
    ...
    foreach ($categories as $category) {
      ...
      <tr>
        ...
        <td><a class="btn btn-success" href="category_artisan.php?category_id=<?php echo $category['id'] ?>"> View </a> </td>
      </tr>
      <?php
    }
     ?>
